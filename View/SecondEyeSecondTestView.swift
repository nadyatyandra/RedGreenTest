...
struct SecondEyeSecondTestView: View {
        ...
        NavigationView {
            ZStack {
                ...
                VStack {
                    Spacer()
                    HStack {
                        Text("Second Test for \(secondEye.name) Eye")
                    ...
                    HStack {
                        Text("Cover your \(secondEye.name == "Left" ? "right" : "left") eye. Move backward and focus on the black ring. On which background do the ring seems sharper?")
                            .foregroundColor(.white)
                                ...
                                RedGreenTemplateView(name: "Red", color: 3, selectedColor: $selectedColor)
                                    .onTapGesture {
                                        if selectedColor == 3 {
                                            ...
                                            secondEye.secondColor = ""
                                            return
                                        }
                                        selectedColor = 3
                                        secondColor = RedGreen(name: "Red")
                                        secondEye.secondColor = "Red"
                                    }
                            }
                        }
                        VStack {
